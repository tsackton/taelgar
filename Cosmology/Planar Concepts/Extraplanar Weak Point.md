...
- Near [[Tokra]], in the [[Hara Basin]], a pair of weak points have existed for time immemorial. One, south of the city, connects to [[Arborea]]. The other, north of the city, connects to [[Pandemonium]]. 
...
%%^Metadata:names:v1%%
- {name: Extraplanar Weak Point, language: unknown}
%%^End%%

%%^povNotes:v1%%
Temporal coverage: broadly modern; the general account incorporates a campaign-scoped catalog with developments through DR 1749.
%%^End%%
