...
%% there is a lot of interesting brainstorming in [[Religious History of Taelgar]] but mostly not definitively canon, so leaving it there instead of copying relevant bits over. however, one thing that needs to be sorted out at some point is whether the "small gods" and the "pantheonic gods" are metaphysically the same or not. I lean towards not, per the brainstorming doc, but this is definitely not settled. %%
## Demigods
