...
tags: [deity, religion/fivesiblings, status/check/tim, status/metadata/image]
gender: male
...
%% Tim: seems "good enough", tagging status/tim to confirm %%
...
His mystery cult, the [[Aagir Mystai]], have no permanent base but function as traveling guardians of the safety of [[Dunmar]]. 

%% holy symbol I think is a spear of some kind, need to look in notes %%
