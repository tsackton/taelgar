...
%%^Metadata:names:v1%%
- {name: Ethereal Plane, language: unknown}
%%^End%%

%%^povNotes:v1%%
Temporal coverage: broadly modern; the article summarizes current travel lore and scholarly debate without a narrower supported date.
%%^End%%