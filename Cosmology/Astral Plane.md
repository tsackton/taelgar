...
%%^Metadata:names:v1%%
- {name: Astral Plane, language: Common, status: inferred}
%%^End%%

%%^povNotes:v1%%
Temporal coverage: broadly modern; the article summarizes current scholarly models and travelers' reports without establishing a narrower historical snapshot.
%%^End%%