...
>[!info]+ Information  
> A [[Dwarves|Dwarven]] cosmological treatise, by [[Harbek Ferrystone]]  
> `$=dv.view("_scripts/view/get_PageDatedValue")`  
> `$=dv.view("_scripts/view/get_Affiliations")`

Planar Tides in Relation to the Dangers of the Plaguelands is a treatise by the dwarven mathematical cosmologist [[Harbek Ferrystone]] about the influence of Limbo on the Material Plane in relation to the [[Plaguelands]].

Though now obscure, Harbek's treatise is an exceptionally detailed work of cosmological mathematics. He begins by noting that the dangers of the [[Plaguelands]] seemed to wax and wane over time, with bursts of extreme danger, such as the [[Blood Plague]] and the [[Cursed Cold]], punctuated by periods of quiescence. Building on [[On Hidden Doors|earlier work]] on planar connections from scholars such as [[Emyr of Tafolwern]], he then proceeds to develop a mathematical theory of planar tides, which Harbek claimed could be used to predict the degree of danger of the [[Plaguelands]]. Specifically, Harbek sought to predict the strength of the connection between Limbo and the Material Plane that he believed influenced the [[Plaguelands]].
