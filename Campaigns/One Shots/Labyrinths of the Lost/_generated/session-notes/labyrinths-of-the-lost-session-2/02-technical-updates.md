---
excludePublish: ["all"]
sessionManifest: "/Users/tim/Library/Mobile Documents/iCloud~md~obsidian/Documents/Taelgar/_sessions/lablost/labyrinths-of-the-lost-002/cleaned/labyrinths-of-the-lost-002-session.yaml"
---
...
- silver icon of The Mother: no matching note found in the vault index
- tarnished silver and yellow topaz: no matching note found in the vault index
- snare trap: no matching note found in the vault index
- hobgoblin loot: no matching note found in the vault index
...
- potion of watchful rest: no matching note found in the vault index
- Perdoli family records: no matching note found in the vault index
- hidden bookcase mechanism: no matching note found in the vault index
- tarnished silver plate: no matching note found in the vault index
- stone statues: no matching note found in the vault index
- silver locket: no matching note found in the vault index
- smuggler's map: no matching note found in the vault index
- love letters: no matching note found in the vault index
- trapdoor to the old hideout: no matching note found in the vault index
- depetrification salve: no matching note found in the vault index
- stone-finger potions: no matching note found in the vault index
<!-- /SLOT -->
