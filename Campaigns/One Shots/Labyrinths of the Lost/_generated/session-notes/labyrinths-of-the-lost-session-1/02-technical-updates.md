...
<!-- SLOT: updates.review -->
- Morky: no matching note found in the vault index
- Norrica: no matching note found in the vault index
- Skelver: no matching note found in the vault index
- Folcan: no matching note found in the vault index
- Ulgna: no matching note found in the vault index
- Grimstone: no matching note found in the vault index
- Perdoli Manor: no matching note found in the vault index
- smith's tools: no matching note found in the vault index
- tinker's tools: no matching note found in the vault index
- magical formal outfit: no matching note found in the vault index
- Loria's short swords: no matching note found in the vault index
- Acescale's playing cards: no matching note found in the vault index
- silver ring with weathered pearl: no matching note found in the vault index
- stolen rations and brandy: no matching note found in the vault index
<!-- /SLOT -->
