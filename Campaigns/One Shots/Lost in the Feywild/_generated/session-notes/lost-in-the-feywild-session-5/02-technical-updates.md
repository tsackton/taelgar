...
- [[27th House|27th Room]]: visited on 1740-10-06.
<!-- /SLOT -->
...
- infected ant colony: no matching note found in the vault index
- fungal seed cloud: no matching note found in the vault index
- white-fiber infection: no matching note found in the vault index
- planar orrery: no matching note found in the vault index
- Thalestria's sealed office door: no matching note found in the vault index
- map library collection: no matching note found in the vault index
