...
- 16 uncut and unpolished gemstones (value would increase if properly cut), taken from the jeweler's workshop at the Elemental Forge
	- Two ruby (Deep red, radiant glow) %%SECRET[5]%%
	- Three garnet (Dark red, glassy appearance) %%SECRET[6]%%
	- Two peridot (Bright green, light-catching sparkle) %%SECRET[7]%%
	- One opal (Multicolored, mystical fire) %%SECRET[8]%%
	- Two citrine (Yellow to orange, sunny and bright) %%SECRET[6]%%
	- Three topaz (Golden yellow, shimmers in light)  %%SECRET[8]%%
	- Two onyx (Black, deep and opaque) %%SECRET[6]%%
	- One lapis lazuli (Blue with gold flecks, royal appearance) %%SECRET[7]%%
## Semi-Magical Items
