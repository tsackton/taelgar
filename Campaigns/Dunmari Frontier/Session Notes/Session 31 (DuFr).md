...
The Dunmar Fellowship thwarts an attack by Agata's allies, safeguards treasure, and liberates Nayan Sura, the rightful heir to Dunmar, from an enchanted mirror.

%% Other Generations
Generation 1
```json
{
  "title": "Treasure and Liberation",
  "tagline": "in which treasures are hidden and prisoners freed",
  "summary": [
    "Dunmar Fellowship is attacked by orcs and other creatures seeking treasure linked to Agata.",
    "Travel to Bas Udda to hide some of Agata's treasure and liberate prisoners trapped in living wood.",
    "On route to Karawa, they destroy cursed items from Agata before crossing Shakun's Protection.",
    "Arrive in Karawa and release Nayan Sura and other prisoners from the Mirror of Soul Trapping.",
    "Sura's liberation hints at potential political upheaval in Dunmar."
  ],
  "short_summary": "The Dunmar Fellowship thwarts an orc attack, hides treasure, destroys cursed items, and frees important prisoners including Nayan Sura, potentially altering Dunmar's politics.",
  "location": "Bas Udda to Karawa"
}
```
%%
## Session Info
### Summary
- Attacked by orcs and other creatures allied with the sorcerer Agata; some treasure and a horse are stolen.
- Travel to Bas Udda and hide treasure; free prisoners from living wood cells.
- Destroy evil magic items from Agata's horde before passing Shakun's Protection.
- Arrive in Karawa and consult Cintra; free Nayan Sura and other prisoners from the Mirror of Soul Trapping.
