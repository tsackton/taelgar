...
- A brass ring set with a garnet, that radiates abjuration magic. Dunmari in origin. Functions as a [Ring of Protection from Fire](https://www.dndbeyond.com/magic-items/5149-ring-of-fire-resistance). Taken from [[Samerki]].  %%SECRET A brass ring set with a garnet, that radiates abjuration magic. This dates to the battle for Tokra, against the fire giant Mavdyr. It was created by the Speaker of the Lakan Mystai, and gifted to a great dwarven warrior who came to the aid of Tokra and helped defeat Mavdyr. It was kept by this dwarf until around 1707, when a group of [[Orcs]] attacked the dwarven frontier. Although they were defeated, and this was a minor sidenote in Dunmari history, the dwarven warrior was killed, and the ring taken by fleeing [[Orcs]]. [[Agata]] acquired it from them, and gifted it to Samerki. Taken from Samerki.(rare major item).  %%
- [Wand of Caustic Arrows](https://www.dndbeyond.com/magic-items/3657480-wand-of-caustic-arrows). This wand appears to be of fey make, but not of [[Agata]]’s creation. Taken from [[Agata]]. %%SECRET Also a fey creation, originally from the Feywild, created for some purpose lost to time and acquired by [[Agata]] somehow over the years. Taken from [[Agata]]'s person.%%
...
- Four dried scorpions in a leather pouch. %%SECRET Will animate, and turn into giant scorpions, when touched or subjected to strong magical effects. %%
...
- A silver ring, set with an obsidian gem. Could sell for 300-1800gp. %%SECRET rare art object%%
- A diamond of beautiful quality and cut. Carried by [[Agata]]. Could sell for 1000-2400gp. Seen in [[Mirror of the Past]]: [[Extravagant Diamond Vision]]. %%SECRET Very rare, exquisite.%%
- Five uncut gemstones: an amethyst (10-60gp %%SECRET common, inferior%%), a rose quartz (50-300gp %%SECRET rare, inferior%%), and a topaz (100-600gp %%SECRET very rare, inferior%%). If cut and polished by a skilled gemcutter, the rubies and topaz could sell for perhaps quadruple; the amethyst and rose quartz could sell for double.
...
- Dream Mirror. A dented copper bowl, radiates divination magic. Origin unclear. %%SECRET Originally created by the Dunmari mystai of Jeevali as a way to help people, basically doing some kind of dream therapy type thing. Taken by hobgoblins during the Bitter Knife war. Then traded to [[Agata]] by a hobgoblin warrior as part of a bargain. [[Agata]] found it too peaceful and twisted it slightly, enchanting the requirement for blood of the person sleeping, and twisting it so the observer could not longer help the sleeper, just watch.%%
- Alchemical Teakettle. A black iron teakettle that appears to be able to hold about a gallon of liquid, and weighs 12 pounds. Probably a dwarven creation. %%SECRET This is a typical Dwarven magic item, useful especially in deep cities where water is scare and hot baths hard to come by. Came to [[Agata]] in a roundabout way, first traded from dwaves to a Dunmari in [[Askandi]], then to pastoralists south of the mesa, then to [[Agata]].%%
...
- Eye of Undead Sensing. A jar filled with liquid in which floats a single human eye, radiating divination magic. When an undead creature comes within 100 feet of the jar, the eye darts about as if it is looking around in panic. Probably a creation of [[Agata]]’s. %%SECRET this is [[Isha]]'s eye %%
...
- [Black Light Candle](https://www.dndbeyond.com/magic-items/3819589-black-light-candle). A candle made of gray wax, radiating evocation magic. Very likely of fey origin.  %%SECRET Created by [[Agata]] from magical wax obtained from shadow bees in the [[Shadowfolds]] that make dark honey. %%
- [Charlatan's Dice](https://www.dndbeyond.com/magic-items/charlatans-die)  A pair of bone dice, radiates illusion magic. Seems to be of fey origin. %%SECRET  A classic fey trick, probably possessed by [[Agata]] for centuries%%
- Displacer Cloak. Carried by [[Drikod]]. %%SECRET A cloak of some shimmering dark leather, radiates transmutation magic. This is the creation of a tricksy archfey, designed to lure humans to their downfall. Once part of a set of seven, this is the only one that remains. [[Agata]] acquired it long ago, years before the Great War, when she was just a young hag. She has given it to many people over the years, always waiting and watching until they are permanently turned, then turning their friends and allies against them, and recovering the cloak once the victim is dead. Cursed the same way the hell hound cloak is. %%
### Mundane Items
- [[Chardon Fan]] %%SECRET common art object%%
- A small wooden box holding six small statuettes, each in the shape of a farm animal. All are clockwork contraptions which, when properly wound, walk and make the appropriate animal noise. There is a cow, a horse, a chicken, a pig, a goat, and a sheep.  Probably worth 10-180gp as a set, perhaps 2-35 gp per item %%SECRET common art object%%
...
- A single turquoise, shaped into a perfect blue sphere the size of a robin’s egg, from [[Agata]]’s hut. Worth 200 - 1200 gp %%SECRET uncommon gemstone, exquisite%%
