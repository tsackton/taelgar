...
A silver rod decorated with a spiraling motif holding a pearly orb, identified as a [[Rod of Elmerca's Bond]]. %%SECRET Apollyon had attempted to destroy this, but failed. Will be pissed to see Delwath holding it.%%
### Rare Components
...
A large book with a deep crimson cover made of bloodstained human skin, radiating necromancy magic, and outlining the process by which a spellcaster can become a lich. Briefly laid a curse on Seeker. Destroyed by Dimitaur. %%SECRET This was Apollyon's recipe book for lichdom%%

A locked book with a plain leather cover, unassuming from the outside. Written in a cypher. Contains notes about Apollyon's spells, functioning as a spellbook. Also contains information and research about the process of lich transformation, and the mechanisms by which the forge in [[Apollyon's tower]] can be used. %%SECRET Careful study can allow one to -- nearly -- recreate the lich transformation tomb; if desired. Contains copies of many, many spells, to be improvised, but Power Word Kill should be a key one if the party investigates. The notes on the forge would require a few days of study but allow magical crafting using the forge. Trapped with a Befuddlement spell, which was triggered by Wellby, who made the save. Now safe to open and read.%%

### Remnants of Apollyon's Constructs

Two small metallic flies, about two inches across and made of a strange black metal, perhaps some kind of unusual iron. Inert. %%SECRET Part of Apollyon's constructs, used to allow them to scout and spy. Improvise ways to get them working again.%%

Two cracked pieces of once-magical crystal that powered the constructs. %%SECRET Probably useless.%%

### Miscellaneous Treasure

Scraps of [[Adamantine]] from Apollyon's lich transformation chamber, totally about 1/2 of a pound. %%SECRET Used in the construction of Apollyon's phylactery.%%

Drankorian coins, totalling 250 gold coins and 3000 silver coins. 

A Drankorian silver water ewer, finely made and decorated with flowing water motifs. %%SECRET Exquisite common art object%%

An large gold serving plate, with fine metalwork and an array of dancing animals forming an elegant border. %%SECRET Exquisite very rare art object%%

Three unadorned gold rings. %%SECRET Uncommon art object. Probably have an interesting history?%%
### Apollyon's Throne
