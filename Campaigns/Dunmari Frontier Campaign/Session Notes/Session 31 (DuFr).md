...
- (DR:: 1748-06-05), afternoon: Hide some treasure from [[Gazetteer/Greater Dunmar/Hara Basin/Agata's Lair]] in [[Bas Udda]]. Free [[Agata]]'s prisoners imprisoned in living wood. 
...
With the threat driven off, the party goes back to sleep, waking some hours past sunrise. In the morning, the party searches for tracks, and realizes that the [[Orcs]] came from [[Gazetteer/Greater Dunmar/Hara Basin/Agata's Lair]], perhaps from the mysterious shadowy hill that was never investigated. The idea that [[Orcs]], perhaps lots of [[Orcs]], may be waiting for them makes the idea of returning to the lair less appealing. The party decides to return to [[Bas Udda]], take some time to hide the heavy loot, and then return to [[Karawa]] to decide what to do.
