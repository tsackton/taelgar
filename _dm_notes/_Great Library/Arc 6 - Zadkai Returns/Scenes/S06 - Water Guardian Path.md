...
The entrance is trivial - just swim down. But of course will require some way to hold your breath or not need to breath. 

## General Conditions

This serves no purpose other than to hold the key. This guardian is particularly malevolent, and is bound tightly to the bottom chamber. The whole construction ensures that the lair itself doesn't freeze. 

### Extreme Cold

The water and temperature becomes colder as you go down. While the top part of area A is manageable, by the middle/end, this is extremely cold water, particularly dangerous (unless you happen to have the fire gemheart). 

The last ~50 feet of the descent, once the ice begins to build up, count as Frigid Water:
...
The rest of the dungeon, areas B-C-D, are Extreme Cold:
...
They also count as Slippery Ice. Creatures that move slowly and carefully automatically succeed on the Saving Throw:
...
*Moving slowly and carefully:* Reduce Speed by 10 feet (this happens *before* Difficult Terrain, so a creature with 30 foot speed can move 10 feet per turn moving carefully across ice)

### Resting

Resting is possible subject to the effects of Extreme Cold, above. 

## Rooms

![[Water Guardian Path]]

The basic shape of the water guardian path is a long, deep vertical descent into ice, then moving throw the ice into an ice cave, which has two levels connected by a crevasse. The guardian is on the bottom level, and is the source of the cold (see: Killing the Guardian, below). 

### Entrance Passage (A)

It is about 250 feet from the entrance to the water passage to the frozen ice plug at the bottom. Visibility is poor, about 20 feet dim light, with darkvision allowing visibility out to 60 feet. Three layers:

(1) Layer 1: normal water, but increasingly cold. Some bits of ice float up. Usually very small. Normal swimming, not cold. 

(2) Layer 2: thermocline, monsters. Gets increasingly cold; the combat should happen in this zone. This is about the widest point of the tunnel. See water combat below. 

(3) Layer 3: frigid water + ice plug. The last 50 feet or so - increasing ice, water temp essentially freezing. Need to find a way through the ice. See ice plug below. 

#### Water Combat

In the middle depths, where it is cold but not too cold, a [Krake Spawn](https://www.dndbeyond.com/monsters/4340112-krake-spawn) lurks. It is emaciated and enchanted to be able to eat ice, but strongly prefers flesh and will attack mercilessly anything warm blooded. Two [ice sharks](https://www.dndbeyond.com/monsters/6575186-ice-elemental) lurk nearby and attack hoping to get some bites in. Flavor the ice shard attack as cold breath, basically and ice claw becomes bite. 

Can plausibly be tamed if they have a source of food. 
...
See Frigid Water, above. This is dangerous terrain to linger in. 

The ice increases dramatically as you reach the bottom, with pillars, sharp spikes, and more. There is about a four foot solid block of ice blocking an ice cave, below. It is translucent - the cave can be dimly seen. Misty Step, Dimension Door or other teleportation options are the easy solution. 

Uneven strength and thickness. DC 15 Nature check can reveal weak point. 

HP is 45, Damage Threshold 15, AC 15. Only takes a few solid hits to crack, but weak hits do nothing, just chip it and it refreezes. Weak point has no damage threshold. 
