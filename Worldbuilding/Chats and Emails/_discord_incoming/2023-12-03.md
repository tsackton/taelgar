...
confidence: "medium"
notes: "Tooling/vault term density. Scores: world=11, tooling=33."
```
...
[2023-12-03 08:22 AM] Deciusmus: Yeah that was on my list but I didn’t get to it. It’s because the lack of q in the format specifier is now ignored
[2023-12-03 08:23 AM] Deciusmus: It should mean “skip the first link text”
...
[2023-12-03 08:31 AM] Deciusmus: Its slightly non-obvious, basically you need to set the default format string to `<name>` if the format doesn’t contain q
[2023-12-03 08:32 AM] Deciusmus: But actually it’s more than that, what I wanted to do was split the filter and the format.
...
[2023-12-03 08:32 AM] Deciusmus: But I haven’t quite thought it all through
[2023-12-03 08:33 AM] rsulfuratus: need a string object
[2023-12-03 08:33 AM] rsulfuratus: 😉
...
[2023-12-03 09:41 PM] rsulfuratus: Might fiddle a bit more - you should push what you’ve been doing even if it isn’t fully functional yet
