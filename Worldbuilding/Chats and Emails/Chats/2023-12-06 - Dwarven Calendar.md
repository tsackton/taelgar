...
%% Source cleanup: extracted from old cleaned Discord source `Discord Chat - Dwarven Calendar.md`; source=Discord; action=promote-after-cleanup; cleanup date=2026-06-03. %%
