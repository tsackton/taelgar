...
[2023-11-11 08:53 AM] rsulfuratus: first, on home/origins - are we assuming that origin is a separate yaml entry, not part of whereabouts? otherwise, i don't see how it is possible for there ever to be a origin whereabout without a home whereabout
    ...
    ```
[2023-11-11 08:54 AM] Deciusmus: You don’t have a home where about if you have a home with an end
[2023-11-11 08:54 AM] rsulfuratus: ah right, okay
[2023-11-11 08:54 AM] Deciusmus: I did change the logic when I was implementing to say just don’t show origin of origin and home are the same
...
[2023-11-11 09:01 AM] Deciusmus: Away locations should have a start. Home locations don’t need dates.
...
[2023-11-11 09:02 AM] Deciusmus: I’m not sure if the spec implies that
...
[2023-11-11 09:09 AM] Deciusmus: Although I think I’d leave location blank on the parse side and set to unknown on output only
...
[2023-11-11 09:19 AM] Deciusmus: I haven't actually implemented the get_Current yet 😄
...
[2023-11-11 01:02 PM] Deciusmus: I’d hardcode it to something
[2023-11-11 01:02 PM] Deciusmus: It doesn’t really need to vary for different pages
[2023-11-11 01:08 PM] Deciusmus: I am actually leaving to go to the fells now… but I pushed what should be working template for the header and js for current and home whereabouts
...
[2023-11-11 01:14 PM] Deciusmus: Yeah probably. Haven’t looked in detail. I’m just not sure the benefit of tags for that kind of thing
...
[2023-11-11 01:17 PM] Deciusmus: Finally I was thinking about gazeetteer and thinking it might be nice to have a “parentLocation” so that it would be easier to find places inside places and so on. Although maybe that can be derived by folder structure
...
![[Worldbuilding/Chats and Emails/_assets/discord/image-30BBC.png]]
