...
# 2023-11-17 - Vault Tooling

%% Source cleanup: promoted from reviewed incoming note `2023-11-17.md`; source=Discord; action=promote-after-cleanup; cleanup date=2026-06-03. %%
...
![[Worldbuilding/Chats and Emails/_assets/discord/image-E23AC.png]]
...
[2023-11-17 05:35 PM] rsulfuratus: I’ll look at the spec
...
[2023-11-17 09:21 PM] rsulfuratus: I like the primary affiliation stuff, that has a lot of advantages, although it was obviously built with your complicated royals in mind 🙂
...
[2023-11-17 09:44 PM] Deciusmus: getRootPath you don’t need. I just use it as a value to pass to getFirstLinkpathDest
[2023-11-17 09:45 PM] Deciusmus: All of that logic is basically boils down to:
    Given a string like “Cece I” find the frontmatter for the file
