...
- Dunmar Frontier: **Canonical**. First half of campaign in OneNote although all text and many images are copied into `_DM_`, and most non-DM details have been copied over; second have of the campaign entirely in Obsidian. 
- Addermarch: **Canonical**. Set in DR 1715. Entirely in Obsidian. 
...
- Great Library campaign: **Canonical**. Set almost entirely (so far) around Voltara, on the northern frontier of the Chardonian Empire. Originally in OneNote, but largely ported. 
