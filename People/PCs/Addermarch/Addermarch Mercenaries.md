...
%%^Metadata:names:v1%%
- {name: Addermarch Mercenaries, role: primary, language: Common, notes: "Plain Common descriptive party name.", status: inferred}
%%^End%%

%%^povNotes:v1%%
Temporal coverage: a DR 1715 active-party snapshot of the three founding members in Caradoc's employ; their later course is not summarized here.
%%^End%%
