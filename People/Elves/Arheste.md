...
(if this conflicts with the Dunmar story above, the Dunmar version is canonical - there are also potentially some minor inconsistencies here with other disorganized notes about the timeline for the end of Drankor, which might need to be resolved)
...
Areste is an info-dump, not really a social conflict; the key is to convince those that know her you are not wasting her time and not bothering in her frail state. 
