...
>> %%^Campaign:dufr%% Met by the [[Dunmar Fellowship]] on December 4th, 1748 in [[Uzgukhar]], [[Xurkhaz]], the [[Garamjala Desert]] %%^End%%
...
%%^Metadata:names:v1%%
- {name: Azogar, role: primary, language: Free Orcish, pronunciation: ah-zoh-GAHR, status: documented}
%%^End%%
