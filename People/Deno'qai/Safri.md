...
%%^Metadata:names:v1%%
- {name: Safri, role: primary, language: Deno'qai, pronunciation: saf-REE, status: documented}
%%^End%%

%%^povNotes:v1%%
Temporal coverage: a DR 1748 portrait centered on Delwath's search for Safri and meeting with her in the Sentinel Range; her earlier life and later activity are not recorded.
%%^End%%
