...
%% validate pronunciation, which is based on ChatGPT Baltic-ish interpretation. change status to documented in the name block once you confirm, and copy to frontmatter  %%
