...
%%^Metadata:names:v1%%
- {name: Alban of Ashcombe, role: primary, language: Sembaran, status: documented, notes: Plain familiar given name plus place byname.}
%%^End%%

%%^povNotes:v1%%
Temporal coverage: a Cleenseau-era snapshot around DR 1720; the note contains only hidden working material, so no later life history is established.
%%^End%%
