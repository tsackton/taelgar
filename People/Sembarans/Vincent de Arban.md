...
> [[Sembara|Sembaran]] [[Humans|human]], he/him of the [[Garay Family]]
> `$=dv.view("_scripts/view/get_PageDatedValue")`
>> `$=dv.view("_scripts/view/get_Whereabouts")`
>> %%^Campaign:Clee%% Met by the [[Heroes of Cleenseau]] on November 7th, 1719 in [[Cleenseau]], the [[Barony of Aveil]], [[Sembara]] %%^End%%
