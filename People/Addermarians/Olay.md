...
%%^Metadata:names:v1%%
- {name: Olay, language: Addermarian, pronunciation: OH-lay, status: documented}
%%^End%%

%%^povNotes:v1%%
Temporal coverage: a DR 1715 historical snapshot ending with Olay's death and interrupted funeral; earlier life is not described.
%%^End%%
