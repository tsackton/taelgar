...
tags: [person, status/cleanup/metadata, status/gameupdate/gl]
...
campaignInfo: [{campaign: GL, type: met, date: 1747-11-18}]
affiliations: [{type: leader, title: Commander, org: "Varentia’s Camp"}]
dm_owner: none
dm_notes: none
---
...
>> %%^Campaign:GL%% Met by the [[Silver Tempests]] on November 18th, 1747 in the [[Varentia's Camp|Voltara Garrison 2]], the [[Northern Provinces]], the [[Chardonian Empire]] %%^End%%
