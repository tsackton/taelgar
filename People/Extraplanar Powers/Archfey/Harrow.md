...
Possible quotes, but need consideration before using:
...
%%^Metadata:names:v1%%
- {name: Harrow, role: primary, language: Common, status: inferred, notes: Common title-name matching the visible fear-of-darkness framing}
%%^End%%

%%^povNotes:v1%%
Temporal coverage: broadly modern identity and relationship to Wend.
%%^End%%
