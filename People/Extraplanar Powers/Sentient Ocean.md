...
Along the coasts of the [[Mawar Confederacy]], the [[Apporia|Apporian Peninsula]], and other regions facing the [[Endless Ocean]], sailors and storytellers sometimes speak of waters far beyond the shore that sing, dream, or remember. These stories do not agree on what this power is, but all speak of a strange, alien power, a living mind of the ocean. 
...
%%^Metadata:names:v1%%
- {name: Sentient Ocean, language: Common, status: documented}
- {name: "Yi'weti", role: alias, language: Aquan, pronunciation: yee-WEH-tee, meaning: "from the living ocean", notes: "Language and meaning recorded in [[Wazir's Gloss on the Ciphered Scroll]].", status: documented}
- {name: Ur Biyiak, role: alias, language: Lizardling, pronunciation: oor bee-YAHK, notes: "Recorded by [[Yaz]] as a name used by lizardfolk sages.", status: documented}
- {name: Wanui Teora, role: alias, language: unknown, pronunciation: wah-NOO-ee teh-OH-rah, notes: "Recorded by [[Yaz]] as a name used by great beasts of the deep.", status: documented}
- {name: "Ma'haya Kabir", role: alias, language: Mawarian, pronunciation: mah-HAH-yah kah-BEER, notes: "Recorded by [[Yaz]] in association with [[Guzo the Mariner]].", status: documented}
%%^End%%
