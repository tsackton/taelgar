...
>> %%^Campaign:dufr%% Met by the [[Dunmar Fellowship]] on July 26th, 1748 at Padma's caravanserai on the [[Tokra-Darba Road]] %%^End%%
...
%%
- (DR:: 1748-08-09): Mystai of Aagir arrive at Padma's estate after dealing with the Copper Hill bandits, and hear the story of how the Dunmar Fellowship killed the wyverns. The mystai decide to continue to Darba.
%%

%%^Metadata:names:v1%%
- {name: Padma, role: primary, language: Dunmari, pronunciation: PAD-mah, status: documented}
%%^End%%
