...
%%^Metadata:names:v1%%
- {name: Zadkai, language: unknown, pronunciation: ZAD-kye,  status: documented}
%%^End%%

%%^povNotes:v1%%
Temporal coverage: a DR 1747 encounter portrait ending with Zadkai's escape; his earlier origin and later whereabouts are unknown.
%%^End%%