...
- [Morbid Memory](https://www.dndbeyond.com/sources/vrgtr/horror-adventures#MorbidMemory)
...
%%^Metadata:names:v1%%
- {name: Scar of Shadowfire, role: primary, language: Common, status: documented, notes: Descriptive name for the barren scar left by the Battle of Shadowfire in DR 1555.}
%%^End%%

%%^povNotes:v1%%
Temporal coverage: broadly modern; the barren scar remains from the DR 1555 battle, while the article does not establish when its supernatural dangers began or might end.
%%^End%%
