...
%% keeping dm notes color until i have a chance to add some vibes notes %%
...
%%^Metadata:map:v1%%
locations:
  - {map: world, locator: 15.08.A05}
%%^End%%

%%^Metadata:names:v1%%
- {name: "Argento", role: "primary", language: "Chardonian", pronunciation: "ar-JEN-toh", status: "documented"}
%%^End%%
