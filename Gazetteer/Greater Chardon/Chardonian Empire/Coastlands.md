...
Five major rivers, in addition to the [[Chasa]], and several smaller ones, flow through the coastlands. From south to north, they are:
- [[Dashun]]
- [[Zar]]
- [[Corvessa]]
- [[Sevros]]
...
%%^Metadata:names:v1%%
- {name: "Coastlands", role: "primary", language: "Common", status: "documented"}
%%^End%%
