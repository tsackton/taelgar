...
whereabouts:
  - {type: home, location: Irrla, linkText: on}
dm_notes: none
dm_owner: tim
...
%%^Date:1748%%
In the DR 1740s, the [[Skullcleaver Clan]] clan has become an increasing threat, turning to coastal raiding, which has driven the Republic of Svolhas, not historically a major naval power, to begin to rapidly build up its maritime forces.
%%^End%%

%%^Campaign:none%%

Non-canon, based on backstory for [[Alimash]] for Wellby solo, but may be useful for development. 

- Government “Athenian-style” with multiple coastal cities and a senate meeting in a leading port (named as Rava).
- Trade-focused intermediary between [[Medju]] and the western ports.
- Sharktooth Wars as a proposed name for a conflict that drove hobgoblins out of parts of Irrla’s interior.

Backstory copied below:
