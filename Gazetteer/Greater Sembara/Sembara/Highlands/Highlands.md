...
%%  status/errors -> Should be reconsidered in light of the rethinking of the history of humanity in the region; the changes in how Tollen-Zimka-Semb valley interact may have changed some of the below; the modern vibes are likely still good though %%
...
%%^Metadata:names:v1%%
- {name: Highlands, role: primary, language: Common, status: inferred, notes: "Plain Common descriptive name."}
- {name: Sembaran Highlands, role: descriptive alias, language: Common, status: documented, notes: "This regional form is used in [[Timeline of Sembaran History]]."}
%%^End%%
