...
tags: [place, status/check/mike, status/cleanup/text]
name: Tyrwingha
typeOf: realm
...
%% tagging check as I'm not sure if there is anything non-canonical here. if it seems it needs a more serious rework, change to status/needswork/old %%
