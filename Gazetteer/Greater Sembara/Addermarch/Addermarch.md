...
- Addermarch is on the other side of the Sunset Gate from Ethlenn; another possibility could be that Ethlenn for some reason could only extend her protection (against, e.g. Morlaith) along the Sunset Gate, and so the people in Addermarch were the ones who stayed in their homes instead of moving back to Tyrwingha (this supposes that pre-Ethlenn, the proto-Tyrwingha spread across the Mostreve Hills, but I actually kind of like this better that point 1). 
- Left unclear per previous discussion is where these people came from, and how they interacted with elves to south and lizardfolk to north pre-Downfall.
- Fundamentally, though, the vibe is that it was Ethlenn/feywild politics that set Addermarch and Tyrwingha on separate courses through history
%%
...
![[addermarch-schematic-details.png]]

A rough schematic to go with the player facing text below, although quality not great. 

The basic vibe is four regions, in red, though there are five earls. These are described in more detail in the player section:
- Western hills
- Central and northern river valley
- Southern borders
- Eastern borders
...
From Mike: I think the combination of the [[War of the Ashen Horde]] and the zombie attacks is a good turning point. The undead attacks in my game never arose much in Addermarch, but there is no canonical reason they couldn't have. The basic idea was the lich cast a spell that pretty much awoke some random percentage of battlefield dead in the broad Enst river valley - and then used his henchman in the army to mismanage the response. The [[Army of the South]] which would have traditionally coordinated with with Addermarch, was in fact maliciously redirected - some to go on a wild goose chase to try to find some fake artifact in the borderlands, and some to defend Embry. The Duke of Wisford managed to redirect some of them, and formed a core of resistance, and fought two battles, one at [[Gowerbourne]] and one at [[Fellburn]]. What was happening in Addermarch is ill-defined, actually. There was no real hint that the undead were _directed_ by the lich at all, it was more like - awaken what he can and then see what happens, mismanaging the response. The only thing I did establish in game was that Tyrwinghan was never invaded, but mustered an army along the Enst near [[Eskbridge]] - clearly due to some type of fear of invasion. 

It is entirely plausible that during this period Tyrwingha - via Ethlenn - is very concerned with protecting its borders, and there could easily have been hobgoblin zombies awakening in the Westcliff and northern parts of Addermarch that attacked south, even though it never came up in game. I had a few rangers from Addermarch come north, but one of the points of the whole thing was it was random and disconnected, and also the dead move at different speeds, so they could easily have come north before Addermarch attacks got bad.

Alternatively the vibe in Addermarch could be more like in Tyrwinghan - fortifying the borders and looking it your own defenses, with a lot of skepticism about what was going in Sembara. Anyone with a brain and the ability to follow troop movements would have realized something was wrong as the monarch was not doing what he should to protect the realm. 
%%
