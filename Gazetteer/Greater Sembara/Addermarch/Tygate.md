...
povNotes: "Accuracy range: the DR 1700s broadly."
%%^End%%

%%^Metadata:names:v1%%
- {name: Tygate, role: primary, language: Addermarian, pronunciation: TY-gayt, meaning: dwelling near a road or entrance, status: documented}
%%^End%%
