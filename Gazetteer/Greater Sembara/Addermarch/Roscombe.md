...
The Temple of the Sibyl is one of the largest buildings in town and the center of Roscombe’s religious life. [[Owen Tavish]] serves there as priest, assisted by temple steward [[Isolde of Roscombe]], who manages temple records, visitors, and secure storage. In DR 1715, the [[Serpentine Dagger]] recovered from [[Torvaine Watch]] was destroyed there with [[Trueflame]] under Owen’s supervision.

The central plaza contains a well and fountain, and supports daily local trade, with larger market days on Wednesdays and Sundays. [[Caradoc]] regularly comes into Roscombe for the Sunday market and often meets clients at the Raven’s Roost.

## Inns and Taverns

>[!info]+ 
> ***[[The Traveler's Rest]].*** The only inn in Roscombe, a well-built two story building against the wall, near the South Gate, where the road from [[Valcroix]] enters town. Run by [[Bertrand LeBlanc]], a charming middle-aged man with a personal connection to the Traveler. Efficient and organized, and a decent cook as well.
> 
...
%%^Metadata:map:v1%%
locations:
  - {map: world, locator: 12.11.C23 }
%%^End%%

%%^Metadata:names:v1%%
- {name: "Roscombe", role: "primary", language: "Addermarian", pronunciation: "ROHS-kom", status: "documented", notes:  derived from ros (heath or moor) and combe (valley), indicating a valley on a heath}
%%^End%%

%%^povNotes:v1%%
Temporal coverage: a DR 1715 portrait of Roscombe during Elowen Duval's castellanship and the Addermarch Mercenaries' activity; the walls and older local history extend beyond that snapshot.
%%^End%%