...
The [[Enst]], by contrast, is difficult to cross and forms a major barrier to movement: flooding, cold currents, and limited towpaths restrict navigation. Ferries (most notably at [[Rinburg]]) and a small number of bridges—most notably at [[Cleenseau]] and [[Eskbridge]]—manage crossings where the banks allow. The Aure supports regular riverboat traffic between [[Adderfell]] and the Enst.
