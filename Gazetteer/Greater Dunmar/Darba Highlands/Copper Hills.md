...
%%^Metadata:names:v1%%
- {name: Copper Hills, role: primary, language: Common, status: inferred, notes: "Descriptive plain-Common name documented by [[Languages]]."}
%%^End%%

%%^povNotes:v1%%
Temporal coverage: broadly modern; the physical geography is durable, while the mining description reflects the current era.
%%^End%%
