...
- The [[Sukal]], a perennial though strongly seasonal river that flows east from the [[Copper Hills]]. 
...
%%^Metadata:names:v1%%
- {name: Hara, role: watershed name, language: Dunmari, pronunciation: HAH-rah, status: documented}
%%^End%%
