...
In DR 1747, an expedition from the [[Great Library]] cleansed the tower's corrupted fountain and recovered the [[Deepwater Scroll]] from a hiding place anchored in the [[Elemental Plane of Water]].
...
%%^Metadata:names:v1%%
- {name: Drowned Tower, language: Common}
%%^End%%
