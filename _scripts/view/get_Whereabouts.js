function get_Whereabouts(metadata) {
    ...
    originString = StringFormatter.getFormattedString(whereabout.origin.location ? (whereabout.origin.originFormat ?? displayDefaults.wOrigin) : displayDefaults.wOriginU, file, pageYear)
