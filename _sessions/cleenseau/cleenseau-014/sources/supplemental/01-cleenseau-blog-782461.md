[ gaming post ] We have determined that it is not, in fact, better down where it's wetter. Actually.

Published: 2024-04-28T18:58:00
Original URL: https://kiya.dreamwidth.org/782461.html
...
The deranged plan involved putting a sheep in a rowboat with some giant fucking fishhooks (I forget the terminology here; [](https://artan.dreamwidth.org/profile)[**artan**](https://artan.dreamwidth.org/)?) and luring the sea serpent out to potentially attack the sheep and then see if we can use a draft team to drag it ashore so we can murder it in comparative peace.
