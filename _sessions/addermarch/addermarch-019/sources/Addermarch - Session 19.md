...
> *In Taelgar: (DR:: 1715-05-27) - (DR:: 1715-05-27)*
...
- (DR:: 1715-05-27), **morning**: After a long rest in the upper mine, the party backtracks through Duncan's camp and finds a ventilation shaft.
- (DR:: 1715-05-27),  **midday**: The party enters the mine, defeats serpentine ghouls, and descends to the lowest levels following signs of Duncan's passage.
## Cast of Characters

- **[[Yvan Greenrabbit]]** - Halfling sorcerer whose spells and a decisive fireball help break the second ghoul fight.
- **[[Drou]]** - Elven bard-monk who takes the lead on the rope, calls on the Staff of the Python, and brings _Moonbeam_ to bear in the deepest tunnels.
...
- **[[Serethwyn Tor]]** - The hill-fort above the mine, where the party climbs to locate an alternate route downward.
...
pseudodragon scouts, sees serpentine ghouls
tie rope via iron spike, start to climb down (Drou first, then Yvan, then Fazoth)
Yvan climbs while Drou still on rope, weight is too much, iron spike pulls out, Drou and Yvan fall, Yvan lands in a heap while Drou lands gracefully
Fazoth misty steps

---

combat 1 - against serpentine ghouls
shatter alerts dungeon, otherwise eldritch blast + pseudodragon (poison but sadly they are immune to poison), sorcerous burst plus a few low level spells deals with enemies
burn bodies
take ~300 silver pieces in treasure
...
lowest level
ghouls licking the walls for specks of serpentine, turn and attack
giant snake takes brunt of damage and gets to quite low HP, gets paralyzed at one point by ghoul attack
tight quarters
witch bolt from fazoth strong
drou mostly daggers and punches, plus snake, plus starry wisp
when enemies mostly dealt with yvan surges into max damage spell
steps forward to fireball
