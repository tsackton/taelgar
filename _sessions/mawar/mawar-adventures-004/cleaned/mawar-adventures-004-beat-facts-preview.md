...
**Time Window**: morning
**Combat**: no
**Short Summary**: Ander reunites with Ryu at the towers, and Jaeson arrives with a rumor about a beast extorting lizardfolk gatza to the north.
**Long Summary**: The session opens with Ander finding Ryu at his weathered tower above Hamri, where the two old friends catch up over tea and talk about changes in town and the strange pull of gatza and the sea. Their reunion is interrupted when Jaeson brings news from the coast: something monstrous is killing lizardfolk near Eskorola and demanding their gatza, hinting at profit even as the threat sounds serious.
**Location**:
- Hamri: Ryu's tower on the cliffs above the bay
  Note: Ander visits Ryu here after returning home to Mawar.
**NPCs**:
- Jaeson (encountered): rumor source. He brings the story of the beast troubling Eskorola and frames it as a gatza opportunity.
**Items**:
- gatza pearl (encountered): Ryu uses a pearl as part of explaining how the ocean and gatza have changed his life.
**Organizations**: none
...
**Combat**: no
**Short Summary**: Ryu and Ander recruit Nerissa, sail to Eskorola, and hear Itzal describe killings, steam, and a threat demanding tribute.
**Long Summary**: After deciding the rumor is worth investigating, Ryu and Ander bring Nerissa into the plan and head north along the coast to the lizardfolk village of Eskorola. There they speak with the elder Itzal, who explains that villagers have been killed by a strange sea beast, that a burned corpse washed ashore with a warning note, and that the attacker seems to want a full payment of gatza left for it in the harbor.
**Location**:
- Hamri -> Eskorola: a half-day sail north to the lizardfolk village
  Note: The beat ends with the party meeting the village elder after arriving.
**NPCs**:
- Itzal (encountered): village elder. He briefs the party on the deaths, the note, and the village crisis.
**Items**:
- threat note (encountered): A handwritten note recovered with a burned body demands gatza tribute within three days.
**Organizations**: none
...
**Items**:
- threat note (encountered): The party inspects the note more closely while planning the next day's approach.
**Organizations**: none
...
**NPCs**: none
**Items**:
- threat note (encountered): The party examines the handwriting and bottle again before entering the marsh.
**Organizations**: none
...
**Combat**: yes (start)
**Main Enemies**:
- steam imps: Ambushers hidden in the fog around the canoe.
**Combat Notes**: The opening clash begins as the party enters the hidden approach to the nest.
...
**Combat**: yes (end)
**Main Enemies**:
- fire cult guardian: A larger defender who joins after the steam creatures and holds the tunnel mouth.
**Combat Notes**: This closes the first marsh fight and leaves the party wounded but still advancing.
...
**Items**:
- black spear (encountered): A burning black spear or arrow is lodged deep in Chaessenth's neck.
**Organizations**: none
...
**Combat**: yes (start)
**Main Enemies**:
- fire mage: Primary hostile controller in the chamber.
**Combat Notes**: The goal shifts from simple survival to freeing Chaessenth from magical control.
...
**Items**:
- black spear (encountered): The party spends the beat trying to loosen it despite the heat and pain.
**Organizations**: none
...
**Combat**: yes (end)
**Main Enemies**:
- fire mage: The last active enemy once Chaessenth is freed.
**Combat Notes**: The chamber fight ends when Chaessenth kills the mage after the party breaks his control.
...
- Chaessenth (companion): freed dragon turtle ally. Once the spear is removed, he helps the party finish the battle.
**Items**:
- black spear (encountered): Its removal is the turning point that lets Chaessenth resist the mage.
**Organizations**: none
...
**Items**:
- golden amulet (encountered): Its symbol matches the mark on Hiyasa's treasure map.
- Hiyasa's treasure map (encountered): The party realizes the map and amulet point toward the same northern island.
**Organizations**: none
