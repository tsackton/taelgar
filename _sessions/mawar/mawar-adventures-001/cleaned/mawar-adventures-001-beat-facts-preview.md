...
- Beats file: /Users/tim/Library/Mobile Documents/iCloud~md~obsidian/Documents/Taelgar/_sessions/mawar/mawar-adventures-001/cleaned/mawar-adventures-001-beats.json
- Beat count: 4
...
**Time Window**: unknown
**Combat**: no
**Short Summary**: Hamri's harbor has been troubled by a phantom ship, disturbed glowing waters, and a day when no fish could be found anywhere along the coast.
**Long Summary**: The summer of 1747 has been strange, with unusual events noted in the harbor: a phantom ship docking one night, a massive creature of epic proportions disturbing the normal bioluminescent glow of the harbor, and a day when no fish could be found anywhere along the coast.
**Location**:
- Hamri: the harbor and waterfront, where a run of strange omens has unsettled the town
  Note: The source frames the opening through signs seen around the port rather than a single interior scene.
**NPCs**: none
**Items**:
- Sentient Ocean (mentioned): The opening title frames the session around a mystery involving the Sentient Ocean.
**Organizations**: none
...
**Combat**: yes (full)
**Main Enemies**:
- water elementals: They attack the merfolk ship during the harbor confrontation.
- twisted fish-like humanoids: They fight alongside the elementals during the assault on the ship.
**Combat Notes**: The whole harbor rescue and battle is contained inside this beat.
