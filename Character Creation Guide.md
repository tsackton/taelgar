...
- Pick a background. We generally just use custom backgrounds, which allows you to pick any two skills, plus two languages or tool proficiencies. You may pick any available background feature, or just trust the DM to give you minor roleplaying bonuses based on your backstory. 
...
Taelgar has extensive homebrewed species options, that exist in various stages of revision. In general, you can assume that homebrew on D&D Beyond is current. Some have been playtested more extensively than others.
