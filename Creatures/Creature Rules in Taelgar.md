...
The concept of a native plane is generally meaningless for constructs, which have no soul anyway. 

Examples include:
- Golems, created by magical rituals
- Animated items, including the creations of the Animate Objects spell or similar magical effects
...
Transformations retain the original metaphysics of the source creature, including their native plane, although in some cases the transformation process may change their metaphysics, particularly if, for example, a divine connection is severed. 

Examples of common transformations include:
- Lycanthropy is a curse of [[Jinnik]] that can turn members of some or all species into lycanthropes. In this case, they retain their original metaphysics, and can be cured. 
- The incorporeal undead are created when souls remain intact after the body has died, and do not pass on or fade. 
- Medusas, by traditional lore, are cursed sapient species, although nothing canonical has been created in Taelgar. 
...
- A variety of bipedal monstrosities in D&D most likely work best as transformations/corruptions of other species or perhaps creatures, although there is little canon lore developed here. Ogres, ettins, cyclopes, and the like could be corruptions or transformations of giants, although this should not be considered canonical  .
...
### Is It a Divinity?
*Note - this name will change and this concept is in flux. See: [[Divinities and Powers - Discussion]] for more work on this.*
...
The default for any new thing should generally be a creature native to the material plane, as this is widely flexible and can account for many diverse things. 
...
Species native to the Material Plane or the Feywild are a fairly complete category. Any new invention here needs to fit in with extensive canon and world development, which will often only be possible if they have very restricted settlement patterns or other features that lead to limited influence on canonical history, politics, and culture. 

The distinction between creatures, transformations, and constructs is often arbitrary and can potentially be made based on vibes. This is generally not worth over-thinking, though consider transformation if obviously related to an existing species or has a vibe of cursed/corrupted. 

Even if a creature is intended to have culture, language, and history, consider whether this might be an exceptional case where a creature has extensive culture, perhaps from a dominant group that spread or evolved (though note the history of the world is a bit short for extensive evolution), or a powerful magic user succeeded in creating something new. A key distinction here is that in this case, one might expect to encounter related creatures that seem similar but with radically different metaphysics and history. Dragonets are a possible example here, as are bullywugs. 

Generally, most things can be shoehorned into the generic creature category if needed, even potentially playable species for a player who really wants something specific. The assumption should be to lean away from species creation until needed. 

In most cases, standard monsters don't need lore invention to use and can be assumed to exist in one of the standard non-species categories. 
...
Often D&D rules use groupings of creature types to convey particular ideas. These can often be translated to Taelgar metaphysics. 

- Anything that references "Celestials, Fiends, Fey, Elementals" as a class should be interpreted as referencing any creature or species not native to the Material Plane, excluding natives of the Far Realms. 
- Anything that references "Celestials, Fiends, Fey, Elementals, Aberrations" as a class should be interpreted as referencing any creature or species not native to the Material Plane, including natives of the Far Realms. 
- Anything that references "Constructs and Undead" as a class is usually hinting at the idea of "doesn't have a soul", and should generally be interpreted to refer to constructs (which includes mindless undead) and natives of the Far Realms. 
- Anything that references "Celestials and Fiends" as a class should generally be interpreted to reference to natives of the Spiritual Realms. 

### Individual Types

- Anything that references Humanoids should generally be interpreted as referencing species native to the material plane.
- Anything that references Constructs should generally be interpreted as referencing creatures that lack a soul and are defined as Constructs on their statblock. This would typically exclude things that are actually extraplanar natives but are defined on their statblock as Constructs, as well as mindless undead. 
- Anything that references Fiends should generally be associated with non-Divine Spiritual Realms, or just demons + devils, depending on context. 
...
- Dragons and Giants should generally be restricted to members of the Giant or Dragon species, potentially including transformations of those species. This might require a spot judgement as to whether a creature like an ogre is in fact a transformation of a giant or not. Alignment with statblock is a reasonable default, unless a storyline requires different. 
...
- _Resurrection_ can bring back the soul of a dead creature that has reached its final resting place, as long as it still exists as some coherent, individual entity. In current metaphysics, this means that Resurrection only works on species whose soulstuff is gifted by divinities, as these are the only creatures who souls pass through the Land of the Dead to the Divine Realms and continue to exist in some fashion there. This obviously includes humans, despite some minimal canon on where exactly human soulstuff comes from and some open questions whether it comes from a divinity or say, the Plane of Creation itself. 
