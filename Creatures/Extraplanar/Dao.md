...
not clear if Dao is the Terran word they use for themselves or some kind of human invention.
%%
...
%%^povNotes:v1%%
Temporal coverage: broadly modern; the note gives an undated creature reference and campaign evidence without asserting a changing present state.
%%^End%%