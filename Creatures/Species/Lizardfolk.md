...
Generally, though, should avoid names that feel clearly linked to real Indo-European languages, and particularly to Tolkien-style Elvish or Dwarvish. 

See more: [[Playing a Lizardfolk#Lizardfolk Names|Lizardfolk Names]]
%%^End%%
## Lifecycle

%% Lizardfolk lifecycle is all over the place:

- In the Kenzo solo, Eric played a lizardfolk adventurer caring for two young infants (pre-walking); these turned out not to really be lizardfolk but given these were not seen as unusual this puts constraints on lizardfolk childhood; in the Aursen marshes the Dunmar Fellowship also encountered a lizardfolk boy of 10 or 12, who looked relatively adult. 
- Lizardfolk elders have been given ages that range from ~115 to ~250, though I believe that most or all of the older individuals could be trivially retconned to be slightly younger if desired. 
- Some brainstorming has focused on two ideas:
	- Lizardfolk communities control fertility intentionally - perhaps new lizardfolk can only be born when the ancestors agree to give a new piece of soulstuff, or agree to allow a piece of themselves to be reincarnated, or something like that - the idea is this is not through strict social control but through magic and some kind of soultstuff vibe
	- Lizardfolk communities have an age structure heavily skewed towards elders; many lizardfolk young would know their great-grandparents and even great-great-grandparents, for example. The basic idea is that lizardfolk mature and age only a little slower than humans, so that something like from 20-100 is roughly equivalent to 20-60 for humans (2 lizardfolk years per 1 human year), but then from 100 on you have something like 5 lizardfolk years per 1 human year, meaning that 100-150 is basically 60s and 150-200 is basically 70s. Perhaps it speeds up a bit past 200. 
- There is a lot of variability in how we've treated young, including uncertainty as to whether lizardfolk bear live young or lay eggs; and uncertainty as to whether lizardfolk young have an aquatic or amphibious phase.
- Old text was: Lizardfolk reach adulthood in their early 20s; the first 5-8 years of their life are spent as amphibious young. Most live into their second century, but few live much beyond 200 years. 
