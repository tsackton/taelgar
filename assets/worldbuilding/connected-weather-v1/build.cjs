...
async function main(){
  ...
  const manifest={title:'Taelgar connected weather patterns',date:'2026-09-26',source:'Background/Climate and Environment/Taelgar Climatic Model.md and the accompanying Sentinel integration discussion',basemap:path.basename(base),frame:[1907,1280],status:'Qualitative review diagrams. Sentinel integration is proposed development; areas and arrows are schematic.',maps:[]};
