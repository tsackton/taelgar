...
!contains(["canal", "river", "gulf", "ocean", "sea", "bay", "brook", "lake", "strait", "waterway"], typeOf) and 
!contains(["duchy", "barony", "realm", "march"], typeOf) and 
!contains(["city", "village", "town", "hamlet", "settlement"], typeOf) and
!contains(["plains", "oasis", "swamp", "canyon", "island", "archipelago", "desert", "forest", "line of hills", "hill", "mountain", "mountain range", "landform"], typeOf) and
