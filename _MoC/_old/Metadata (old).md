...
9. Conclude with a **## Secrets** section that contains DM-only information. This will generally be based on information enclosed in `%%SECRET[v2:60fb8c52e507de7a68241ef760f587be]%%` tags in the provided markdown.
